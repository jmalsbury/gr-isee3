...
# Title: Uplink
# Generated: Wed May 21 22:08:25 2014
##################################################
...
class uplink(grc_wxgui.top_block_gui):
    ...
    def __init__(self, sym_rate=256, samp_per_sym=256, tx_gain=15, nominal_uplink_freq=2041.95e6, lo_off=5e6, backoff=0.150):
...
if __name__ == '__main__':
    ...
    tb = uplink(sym_rate=options.sym_rate, samp_per_sym=options.samp_per_sym, tx_gain=options.tx_gain, nominal_uplink_freq=options.nominal_uplink_freq, lo_off=options.lo_off, backoff=options.backoff)
    tb.Start(True)
    tb.Wait()
